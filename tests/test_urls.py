...
class ViewTests(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        if os.path.exists('data/output_test_doubts.csv'):
            os.remove('data/output_test_doubts.csv')
    ...
    def test_save_row(self):
        ...
        self.assertFalse(os.path.exists('data/output_test_partial.csv'))
        response = self.app.post('/save_row/', data=json.dumps(data), content_type='application/json')
        self.assertNotEqual(response.status_code, 404)
        self.assertTrue(os.path.exists('data/output_test_partial.csv'))
    ...
    def test_save_last_row(self):
        ...
        response = self.app.post('/save_row/', data=json.dumps(data), content_type='application/json')
        self.assertNotEqual(response.status_code, 404)
        self.assertTrue(os.path.exists('data/output_test.csv'))

    def test_get_previous_row_saved(self):
        self.test_save_row()
        df = pd.read_csv('data/output_test_partial.csv', sep=';', encoding='utf-8')
    ...
    def test_save_doubt(self):
        ...
        self.assertFalse(os.path.exists('data/output_test_doubts.csv'))
        response = self.app.post('/save_doubt/', data=json.dumps(data), content_type='application/json')
        self.assertNotEqual(response.status_code, 404)
        self.assertTrue(os.path.exists('data/output_test_doubts.csv'))
